	...
	<div class="Dbox">
		<div class="box">
			...
			<div class="cent">
				...
				<form id="ys_bb" action="select_by_color_version.do" method="post">
					<input type="hidden" value="${spu_id }" name="spu_id"/>
					<div class="clear">
						<div id="color" class="min_t">选择颜色2</div>
							<c:forEach items="${list_color}" var="color">
									<div class="min_mx">
										<a href="javascript:;" >${color.shp_ys}</a> 
					...
					<div class="clear">
						<div id="version" class="min_t">选择版本2</div>
							<c:forEach items="${list_version}" var="version">
									<div class="min_mx">
										<a href="javascript:;" onclick="subform()">${version.shp_bb}</a>
										<input type="radio" name="version_id" value="${version.id }" />
									</div>
							</c:forEach>
					</div>
				</form>
				...
				<div class="clear" style="margin-top:20px;">
					...
					<div class="num_box">
						<input type="text" id=""abc onchange="change_tjshl()" name="num" value="1" style="width:40px;height:32px;text-align:center;float:left">
						<div class="rg">
				...
				<div class="clear" style="margin-top:20px;">
						<form  id="cart_form" action="add_cart.do" method="post">
							...
							<input type="hidden" id="h_tjshl"name="tjshl" value="1" />
